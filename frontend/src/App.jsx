...
function App() {
  ...
  const fetchResults = async () => {
    ...
    setError(null);
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL || 'https://halal-compliance-backend.onrender.com'}/api/results`);
        ...
        <>
          <div className="visualization-container">
            {imageError ? (
              ...
              <img 
                src={`${import.meta.env.VITE_API_URL || 'https://halal-compliance-backend.onrender.com'}/api/visualizations/${selectedModel}/2d/condition${selectedCondition}.png`}
